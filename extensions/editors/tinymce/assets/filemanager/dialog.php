                        ...
                        <div class="filters">
                            <div class="row-fluid">
                                <div class="span4 half">
                                    ...
                                    <?php if ($upload_files) { ?>
                                        <button class="tip btn upload-btn" title="<?php echo lang_Upload_file; ?>"><i
                                                    class="rficon-upload"></i></button>
                                    <?php } ?>
                                    <?php if ($create_text_files) { ?>
                                        <button class="tip btn create-file-btn" title="<?php echo lang_New_File; ?>"><i
                                                    class="icon-plus"></i><i class="icon-file"></i></button>
                                    <?php } ?>
                                    <?php if ($create_folders) { ?>
                                        <button class="tip btn new-folder" title="<?php echo lang_New_Folder ?>"><i
                                                    class="icon-plus"></i><i class="icon-folder-open"></i></button>
                                    <?php } ?>
                                    <?php if ($copy_cut_files || $copy_cut_dirs) { ?>
                                        <button class="tip btn paste-here-btn" title="<?php echo lang_Paste_Here; ?>"><i
                                                    class="rficon-clipboard-apply"></i></button>
                                        <button class="tip btn clear-clipboard-btn"
                                                title="<?php echo lang_Clear_Clipboard; ?>"><i
                                ...
                                <div class="span2 half view-controller">
                                    ...
                                    <button class="btn tip<?php if ($view == 0) echo " btn-inverse"; ?>" id="view0"
                                            data-value="0" title="<?php echo lang_View_boxes; ?>"><i
                                                class="icon-th <?php if ($view == 0) echo "icon-white"; ?>"></i>
                                    </button>
                                    <button class="btn tip<?php if ($view == 1) echo " btn-inverse"; ?>" id="view1"
                                            data-value="1" title="<?php echo lang_View_list; ?>"><i
                                                class="icon-align-justify <?php if ($view == 1) echo "icon-white"; ?>"></i>
                                    </button>
                                    <button class="btn tip<?php if ($view == 2) echo " btn-inverse"; ?>" id="view2"
                                            data-value="2" title="<?php echo lang_View_columns_list; ?>"><i
                                                class="icon-fire <?php if ($view == 2) echo "icon-white"; ?>"></i>
                                    </button>
                                </div>
                                <div class="span6 half types">
                                    ...
                                    <?php if ($_GET['type'] != 1 && $_GET['type'] != 3) { ?>
                                        ...
                                        <label id="ff-item-type-1" title="<?php echo lang_Files; ?>" for="select-type-1"
                                        ...
                                        <label id="ff-item-type-2" title="<?php echo lang_Images; ?>"
                                        ...
                                        <label id="ff-item-type-3" title="<?php echo lang_Archives; ?>"
                                        ...
                                        <label id="ff-item-type-4" title="<?php echo lang_Videos; ?>"
                                        ...
                                        <label id="ff-item-type-5" title="<?php echo lang_Music; ?>" for="select-type-5"
                                               class="tip btn ff-label-type-5"><i class="icon-music"></i></label>
                                    <?php } ?>
                                    <input accesskey="f" type="text"
                                           ...
                                           placeholder="<?php echo fix_strtolower(lang_Text_filter); ?>..."
                                    ...
                                    <label id="ff-item-type-all" title="<?php echo lang_All; ?>"
                                           ...
                                           class="tip btn btn-inverse ff-label-type-all"><i
                                                class="icon-align-justify icon-white"></i></label>
                                    ...
                                    <div class="img-precontainer">
                                        <div class="img-container directory"><span></span>
                                            <img class="directory-img"
                                                 src="img/<?php echo $icon_theme; ?>/folder<?php if ($file == "..") {
                                                     echo "_back";
                                                 } ?>.jpg" alt="folder"/>
                                        </div>
                                    </div>
                                ...
                                <?php } else { ?>
                                    ...
                                    <figcaption>
                                        <a href="javascript:void('')"
                                           ...
                                           title="<?php echo lang_Rename ?>"
                                           data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>"
                                           data-thumb="<?php echo $thumbs_path . $subdir . $file; ?>">
                                        ...
                                        <a href="javascript:void('')"
                                           ...
                                           data-confirm="<?php echo lang_Confirm_Folder_del; ?>"
                                           data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>"
                                           data-thumb="<?php echo $thumbs_path . $subdir . $file; ?>">
                    ...
                    <li class="ff-item-type-<?php echo $class_ext; ?> file" data-name="<?php echo $file; ?>"><?php
                        ...
                        <figure data-name="<?php echo $file ?>" data-type="<?php if ($is_img) {
                            ...
                            <a href="javascript:void('')" class="link" data-file="<?php echo $file; ?>"
                               data-field_id="<?php echo $field_id; ?>" data-function="<?php echo $apply; ?>">
                                <div class="img-precontainer">
                                    <?php if ($is_icon_thumb) { ?>
                                        <div class="filetype"><?php echo $extension_lower ?></div><?php } ?>
                                    <div class="img-container">
                                        <span></span>
                                        <img alt="<?php echo $filename . " thumbnails"; ?>"
                                             class="<?php echo $show_original ? "original" : "" ?> <?php echo $is_icon_thumb ? "icon" : "" ?>"
                                             src="<?php echo $src_thumb; ?>">
                                    </div>
                                </div>
                                <div class="img-precontainer-mini <?php if ($is_img) echo 'original-thumb' ?>">
                                    <div class="filetype <?php echo $extension_lower ?> <?php if (in_array($extension_lower, $editable_text_file_exts)) echo 'edit-text-file-allowed' ?> <?php if (!$is_icon_thumb) {
                                        echo "hide";
                                    ...
                                    <div class="img-container-mini">
                                        ...
                                        <?php if ($mini_src != "") { ?>
                                            <img alt="<?php echo $filename . " thumbnails"; ?>"
                                                 class="<?php echo $show_original_mini ? "original" : "" ?> <?php echo $is_icon_thumb_mini ? "icon" : "" ?>"
                                                 src="<?php echo $mini_src; ?>">
                                        <?php } ?>
                                    </div>
                                </div>
                                <?php if ($is_icon_thumb) { ?>
                            ...
                            <figcaption>
                                <form action="force_download.php" method="post" class="download-form"
                                    ...
                                    <?php if ($is_img && $src_thumb != "") { ?>
                                        <a class="tip-right preview" title="<?php echo lang_Preview ?>"
                                    ...
                                    <?php } elseif (($is_video || $is_audio) && in_array($extension_lower, $jplayer_ext)) { ?>
                                        <a class="tip-right modalAV <?php if ($is_audio) {
                                           ...
                                           data-url="ajax_calls.php?action=media_preview&title=<?php echo $filename; ?>&file=<?php echo $current_path . $rfm_subfolder . $subdir . $file;; ?>"
                                    ...
                                    <?php } elseif ($preview_text_files === TRUE && in_array($extension_lower, $previewable_text_file_exts)) { ?>
                                        <a class="tip-right file-preview-btn" title="<?php echo lang_Preview ?>"
                                           data-url="ajax_calls.php?action=get_file&sub_action=preview&title=<?php echo $filename; ?>&file=<?php echo $current_path . $rfm_subfolder . $subdir . $file;; ?>"
                                           href="javascript:void('');"><i class=" icon-eye-open"></i></a>
                                    <?php } else { ?>
