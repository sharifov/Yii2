...
class m160309_154340_create_table_fv_widget_areas_treatment extends Migration
{
    public $tableSanatoriumRooms = 'fv_widget_areas_treatment';
    ...
    public function up() {
        ...
        CREATE TABLE `" . $this->tableSanatoriumRooms . "` (
              ...
              `areas_treatment_id` int(11) unsigned NOT NULL  COMMENT 'id направлений лечения',
            ...
            ) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Виджет направление лечения';
        ");
