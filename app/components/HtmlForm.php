...
use frontend\components\DateRangePicker\DateRangePicker;
use Yii;
...
use thread\widgets\form\select2\Select2;
use kartik\widgets\Select2 as kartikSelect2;
use thread\extensions\editors\Editor;
...
final class HtmlForm {
     ...
     * @param string $attribute
     */
    public static function textInput($model, $attribute) {
        ?>
     ...
     * @param array $setting
     */
    public static function selected($model, $attribute, $datalist, $url = null, $setting = array()) {
...
//            'data' => ['11' => '11'], //
    ...
    public static function buttonPanel($model, $view) {
        ...
        <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'action_add_and_exit') : Yii::t('app', 'action_save_and_exit'), ['class' => 'btn btn-info action_save_and_exit']); ?>
        <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'action_add') : Yii::t('app', 'action_save'), ['class' => 'btn btn-success']); ?>
...
//                            console.log("clear");
    ...
    public static function imageOne($model, $attribute, $extra = ['image_url' => '']) {
        ...
        $imagePreview = (isset($extra['image_url']) && !empty($extra['image_url'])) ?
                Html::img($extra['image_url'], ['class' => 'file-preview-image']) : '';
        ?>
        <div class="row form-group">
            <div class="col-sm-12">
                <?= static::labelBlock($model, $attribute); ?>
